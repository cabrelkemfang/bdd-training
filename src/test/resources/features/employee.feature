Feature: Employee management operations
  ...
  Scenario: Create Employee
    ...
    Then L'employé doit être créé avec succès avec le message: "Employee created"

#  Scenario: Get Employee by ID
#    Given L'utilisateur souhaite consulter les détails d'un employé avec l'ID 1
...
#    When L'utilisateur soumet la requête pour obtenir les détails de l'employé
#    Then La requête doit échouer avec le message suivant: "Employee Not Found 99"
#
...
#    When L'utilisateur soumet la requête pour créer l'employé
#    Then La requête doit échouer avec le message suivant: "Employee with email john@gmail.com already exists."